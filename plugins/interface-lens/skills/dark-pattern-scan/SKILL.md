...
description: Escaneo adversarial de dark patterns antes de shippear — rastrea flujos completos (suscripción, checkout, consentimiento, cancelación), mide la asimetría de fricción entrada/salida y devuelve un reporte pasa/falla con evidencia por archivo y línea.
